...
def bottleneck(inputs,
    ...
    with variable_scope.variable_scope(scope, 'bottleneck_v2', [inputs]) as sc:
        ...
        residual = layers_lib.conv2d(
            preact, depth_bottleneck, [1, 1], stride=1, scope='conv1', data_format=ve_data_format)
        ...
        residual = layers_lib.conv2d(
            ...
            normalizer_fn=None,
            activation_fn=None,
            scope='conv3', data_format=ve_data_format)
            ...
            with arg_scope([layers.batch_norm], is_training=is_training):
                ...
                if include_root_block:
                    ...
                    net = layers.max_pool2d(
                        net, [3, 3], stride=2, scope='pool1', data_format=ve_data_format)
                ...
                net = layers.batch_norm(
                    net, activation_fn=nn_ops.relu, scope='postnorm', data_format=ve_data_format)
                if global_pool:
                    # Global average pooling.
                    net = math_ops.reduce_mean(
                        net, ve_pixels, name='pool5', keepdims=True)
                if num_classes is not None:
                    net = layers_lib.conv2d(
                        ...
                        activation_fn=None,
                        normalizer_fn=None,
                        scope='logits', data_format=ve_data_format)
